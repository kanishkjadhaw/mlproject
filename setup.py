...
setup(
    name='Student',  # Specify the name of the package
    version='0.0.1',  # Specify the version of the package
    author='kanishk_jadhaw',  # Specify the author of the package
    author_email='kaniahkjadhaw@gmail.com',  # Specify the author's email
